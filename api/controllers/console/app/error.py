...
class ProviderQuotaExceededError(BaseHTTPException):
    ...
    description = "Your quota for Voyager Social AI Hosted Model Provider has been exhausted. " \
...
class ProviderModelCurrentlyNotSupportError(BaseHTTPException):
    ...
    description = "Voyager Social AI Hosted OpenAI trial currently not support the GPT-4 model."
    code = 400
