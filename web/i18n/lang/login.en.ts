const translation = {
  ...
  welcome: 'Welcome to Voyager Social AI, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Voyager Social AI Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on Voyager Social AI',
  invalid: 'The link has expired',
  explore: 'Explore Voyager Social AI',
