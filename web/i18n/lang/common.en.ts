const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Voyager Social AI account',
    langGeniusAccountTip: 'Your Voyager Social AI account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Voyager Social AI to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Voyager Social AI allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Voyager Social AI\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Voyager Social AI {{version}} is now available.',
    latestAvailable: 'Voyager Social AI {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Overview',
